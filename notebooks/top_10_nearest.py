# Return 10 nearest station/school/park ... to your property
import pandas as pd
...
class LocationFinder:
    ...
    def top_10_nearest(self, latitude, longitude, csv_file_path):
        """
        ...
        Calculate the top 10 nearest location and return in dataframe
        """
        ...
        # Sort by distance and return the top 10 nearest locations
        top_10_nearest_locations = location_df.sort_values(by='distance').head(10)
        
        return top_10_nearest_locations
